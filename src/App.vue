    ...
    <v-app-bar app clipped-left>
      ...
      <v-toolbar-title>
        ...
        <span v-show="$vuetify.breakpoint.smAndUp"
          >Подтвержденные случаи заболевания во всем мире</span
        >
      </v-toolbar-title>
      <v-spacer></v-spacer>
    ...
    <v-content>
      <v-container>
        ...
        <v-row>
          <v-col cols="12" md="6">
            <FatalityRateByAge
              title="Коэффициент смертности по графику"
              :data="fatalityRate.byAge"
            />
          </v-col>
          <v-col cols="12" md="6">
            <FatalityRateBySex
          ...
          <v-card-text>
            ...
            >
              ...
              <p class="text-center">
                ...
                <br />
                <span class="title">Подтвержденные</span>
              </p>
              ...
              <p class="text-center">
                ...
                <br />
                <span class="title">Выздоровленные</span>
              </p>
            </div>
          </v-card-text>
